...
#include "Lumen/Internal/API/Vulkan/VulkanBuffers.hpp"
...
namespace
{
    ...
    {
        auto func = (PFN_vkCreateRayTracingPipelinesKHR)vkGetInstanceProcAddr(Lumen::Internal::VulkanContext::GetVkInstance(), "vkCreateRayTracingPipelinesKHR");
    ...
    {
        auto func = (PFN_vkCreateRayTracingPipelinesNV)vkGetInstanceProcAddr(Lumen::Internal::VulkanContext::GetVkInstance(), "vkCreateRayTracingPipelinesNV");
