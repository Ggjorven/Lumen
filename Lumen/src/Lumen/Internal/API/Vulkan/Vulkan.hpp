...
////////////////////////////////////////////////////////////////////////////////////
template<>
struct Lumen::Enum::Range<VkResult>
{
public:
...
namespace Lumen::Internal
{
    ...
    inline constexpr VkPhysicalDeviceDescriptorIndexingFeatures g_VkRequestedDescriptorIndexingFeatures = {
        ...
        .descriptorBindingUpdateUnusedWhilePending = VK_FALSE, // Needed for BatchRenderer for multiple batches
    ...
    #define VK_VERIFY_IMPL2(expr, str, num)                                                                         \
        ...
        LU_LOG_ERROR("Expression '{0}' failed with error code: {1}", str, ::Lumen::Enum::Name(result##num))
    ...
    #else
        #error Lumen Vulkan: Unsupported platform...
    #endif
